...
void loop() {
  Serial.println("1");
  uint16_t clear, red, green, blue; // Create variables to store the color values
  Serial.println("11");
  tcs.getRGBC(&red, &green, &blue, &clear); // Read the color values and store them in the variables
  tcs.lock();
  Serial.println("2");
    // turn off LED 
